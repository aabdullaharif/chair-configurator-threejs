...
export const Model = (props)=> {
  ...
  const {chairMaterial, cushionMaterial, chairColor, legs, cushionColor} = useSelector(state=>state.modelSlice);
    ...
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Chair.geometry}>
        <meshStandardMaterial 
          { ...chairMaterial === "leather" ? leatherTextureProps : fabricTextureProps} 
          color={chairColor.color}
        />
      </mesh>  
      <mesh geometry={nodes.Cushion.geometry} position={[0, 0.064, 0.045]}>
        <meshStandardMaterial 
          {...cushionMaterial === "leather" ? leatherTextureProps : fabricTextureProps}
